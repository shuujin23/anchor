...
const commands = new Set(['checkUpdates','downloadUpdate','installUpdate','status','setup','unlock','lock','activity','credentials','credential','saveCredential','deleteCredential','copySecret','copyText','generatePassword','reminders','saveReminder','reminderAction','deleteReminder','history','runbooks','runbook','saveRunbook','deleteRunbook','runbookSessions','runbookSession','startRunbook','runbookSessionAction','settings','saveSettings','testWindows','testDiscord','exportBackup','importBackup','pickBackupFolder','saveAutomaticBackup','automaticBackupNow']);
